...
export function b2Dot(a, b) {
    return a.u0 * b.u0 + a.u1 * b.u1;
}

export function b2Cross(a, b) {
    return a.u0 * b.u1 - a.u1 * b.u0;
}

export function b2AddVV(a, b) {
    const u0 = a.u0 + b.u0;
    const u1 = a.u1 + b.u1;
    return new b2Vec2(u0, u1);
}

export function b2SubVV(a, b) {
    const u0 = a.u0 - b.u0;
    const u1 = a.u1 - b.u1;
    return new b2Vec2(u0, u1);
}
...
// ----------------------------------------------------------------------------
export function b2Interp(v0, v1, t)
{
...
// ----------------------------------------------------------------------------
export function b2Distance(n, v, x)
{
...
// ----------------------------------------------------------------------------
export function b2Inverse(a, b, c, d) {
    const det = a * d - b * c;
